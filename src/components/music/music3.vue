...
<script>
    ...
    import * as PIXI from 'pixi.js/bin/pixi.dev.js'
    ...
    export default {
        ...
        methods: {
            initMusic3() {
                ...
                var AUDIO_URL, TOTAL_BANDS, analyser, analyserDataArray, arrCircles, audio, build, buildCircles,
                    canplay, changeMode, changeTheme, circlesContainer, cp, createCircleTex, gui, hammertime, init,
                    initAudio, initGUI, initGestures, isPlaying, k, message, modes, mousePt, mouseX, mouseY, params,
                    play, renderer, resize, stage, startAnimation, texCircle, themes, themesNames, update, v, windowH,
                    windowW, app, isPlay, changePlay;
                ...
                initGUI = function () {
                    var isPlayController, modeController, sizeController, themeController;
                    gui = new dat.GUI();
                    // if window.innerWidth < 500
                    gui.close();

                    isPlayController = gui.add(params, 'Play', isPlay);
                    isPlayController.onChange(function (value) {
                        return changePlay(value);
                    });
                ...
                startAnimation = function () {
                    return window.requestAnimFrame(update);
                };
                ...
                createCircleTex = function () {
                    ...
                    // return app.renderer.generateTexture(gCircle);
                };
                ...
                changeTheme = function (name) {
                    ...
                    for (i = j = 0, ref = params.numParticles - 1;
                        ...
                        circle.blendMode = params.theme === "blackWhite" ? PIXI.blendModes.NORMAL : PIXI.blendModes
                            .ADD;
                    ...
                    for (i = j = 0, ref = params.numParticles - 1;
                        ...
                        switch (params.mode) {
                            ...
                            case modes[0]:
                                ...
                                results.push(circle.yInit = cp.y + (Math.random() * params.sizeH - params.sizeH /
                                    2));
                                break;
                                // circular
                            case modes[1]:
                ...
                update = function () {
                    ...
                    // return renderer.render(app.stage);
                };
