<template>
    <div class="music1 audio-container">
        <!-- <effect3Vue></effect3Vue> -->
        <div class="audiosvg-container">
            <h1 class="play-text">play</h1>
            <h1 class="pause-text">pause</h1>
            <div class="active-box" @click="pauseAudio()"></div>
            <svg class="audiosvg" @click="playAudio()" viewBox="0 0 250 250" style="enable-background:new 0 0 250 250;"
                xml:space="preserve">
                ...
                <g>
                    <g>
                        ...
                        <path class="st1"
                            d="M159.8,51.3c0-1.3,0.2-2.5,0.5-3.7s0.8-2.3,1.4-3.3s1.3-2,2.2-2.8c0.8-0.8,1.8-1.6,2.8-2.2
...
<script>
    ...
    // import effect3Vue from "../specialEffects/effect3.vue";

    var audioMp3 = new Audio();
    // audioMp3.src = require('../../assets/music/vision.mp3');
    ...
    export default {
        ...
        methods: {
            initMusic1() {
                ...
                TweenMax.fromTo('.loading-image', 2, {
                    scale: 1,
                    autoAlpha: 1
                }, {
                    scale: 0.75,
                ...
                $('.audiosvg').hover(() => {
                    var hoverCircle = $(this).find('#hover-circle .st4')
                    $(hoverCircle).css({
                        'fill': '#7691BA'
                    });
                ...
                $('.active-box').hover(() => {
                    var hoverCircle = $(this).parent().find('#hover-circle .st4')
                    $(hoverCircle).css({
                        'fill': '#7691BA'
                    });
