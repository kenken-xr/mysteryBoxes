      ...
      <div class="cont_modal cont_modal_active">
        <div class="cont_photo">
          ...
          <div class="cont_detalles">
            ...
            <p>orem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sagittis est est aliquam, sed faucibus
              massa lobortis. Maecenas non est justo.</p>
          </div>
        </div>
        <div class="cont_text_ingredients">
          <div class="cont_over_hidden">
            ...
            <div class="cont_text_det_preparation">
              ...
              <div class="cont_text_det_preparation">
                ...
                <div class="cont_info_preparation">
                  <p>在一个大煎锅中加热油，盖上中低的锅头。加入洋葱和铃纸。用文火煮大约20分钟，直到非常软。加入大蒜，煮1 -
                    2分钟，直到变软;加入孜然和红辣椒炒1分钟。倒入番茄，用3/4茶匙盐和1/4茶匙胡椒粉调味;</p>
                </div>
          ...
          <div class="cont_btn_open_dets">
            <a href="#e" @click="open_close"><i class="material-icons">&#xE314;</i></a>
          </div>
